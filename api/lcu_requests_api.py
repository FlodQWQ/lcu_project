...
class Thread_2(QThread):
    ...
    def run(self):
        ...
        def get_ranked_info():
            ...
            if solo_tier != 'MASTER' or 'GRANDMASTER' or 'CHALLENGER':
                solo_division = response_json['queueMap']['RANKED_SOLO_5x5']['division']
            else:
                solo_division = 'NONEED'
            solo_point = response_json['queueMap']['RANKED_SOLO_5x5']['leaguePoints']
            flex_tier = response_json['queueMap']['RANKED_FLEX_SR']['tier']
            if flex_tier != 'MASTER' or 'GRANDMASTER' or 'CHALLENGER':
                flex_division = response_json['queueMap']['RANKED_SOLO_5x5']['division']
            else:
                flex_division = 'NONEED'
