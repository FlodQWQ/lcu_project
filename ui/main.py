...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(30, 60, 401, 171))
        ...
        self.label_gamezone = QtWidgets.QLabel(self.gridLayoutWidget)
        font = QtGui.QFont()
        font.setFamily("Source Code Pro")
        font.setPointSize(14)
        self.label_gamezone.setFont(font)
        self.label_gamezone.setObjectName("label_gamezone")
        self.gridLayout.addWidget(self.label_gamezone, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "区服:"))
        self.label_gamezone.setText(_translate("MainWindow", "-"))
