...
if __name__ == "__main__":
    ...
    Exec = execute()
    Exec.get("6477", "3a9e4148-c910-5093-b9f2-f10f96ea2837", "Basic cmlvdDpkWEtMMVZ2Q0RzYWRkV1lrdWVfOURB", 20)
    shutdownJVM()
    # https: // 127.0
    # .0
    # .1: 6477 / lol - match - history / v1 / products / lol / 3
    # a9e4148 - c910 - 5093 - b9f2 - f10f96ea2837 / matches?begIndex = 0 & endIndex = 20